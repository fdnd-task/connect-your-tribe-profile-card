...
- Test het visitekaartje op toegankelijkheid door in ieder geval een tabtest uit te voeren. Tab door de website heen en merk op of je alle belangrijke functionaliteiten kunt bereiken. Voer eventueel nog een andere test uit van de A11y project (pak daarvoor de [Wcag audit test deeltaak](https://github.com/fdnd-task/wcag-audit/blob/main/docs/INSTRUCTIONS.md#2-handmatige-tests) er nog eens bij uit sprint 3.)
